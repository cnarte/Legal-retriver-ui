...
def main():
    ...
    st.set_page_config(page_title="Legal Document Retriver Demo", page_icon="https://haystack.deepset.ai/img/HaystackIcon.png")
...
""",
    ...
    <div class="haystack-footer">
        <hr />
        <h4>Built by <a href="https://www.linkedin.com/in/cnarte/">Ankit Cnarte</a> 0.1.1</h4>
    </div>
    """,
        unsafe_allow_html=True,
    )
